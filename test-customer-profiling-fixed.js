...
/**
 * Test Customer Profiling Features - CommonJS Version
 * 
...
try {
  ...
  function calculateRiskScore2(customerProfile, config = {}) {
    const {
      zeroRiskMaxFailed = 2,
      zeroRiskMaxReturnRate = 10.0,
      mediumRiskMaxFailed = 5,
  ...
  const risk1 = calculateRiskScore2(customerProfile);
  ...
  const risk2 = calculateRiskScore2(customerProfile);
  ...
  customerProfile = simulateOrderEvent(customerProfile, 'ORDER_CANCELLED');
  const risk3 = calculateRiskScore2(customerProfile);
  ...
  const risk4 = calculateRiskScore2(customerProfile);
